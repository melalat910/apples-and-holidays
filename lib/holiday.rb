...
def add_supply_to_memorial_day(holiday_hash, supply)
  # again, holiday_hash is the same as the ones above	  # again, holiday_hash is the same as the ones above
  # add the second argument to the memorial day array	  # add the second argument to the memorial day array
